...
class MenuManager {
    constructor(bitsDraw) {
        this.app = bitsDraw;
        console.log('🍎 MenuManager constructor called with app:', bitsDraw);
        console.log('🍎 App has setTheme method:', typeof bitsDraw.setTheme === 'function');
        this.setupMenuBar();
    }

    setupMenuBar() {
        console.log('🔧 MenuManager setupMenuBar called');
        const menuItems = document.querySelectorAll('.menu-item');
        const menuDropdowns = document.querySelectorAll('.menu-dropdown');
        console.log('📋 Found menu items:', menuItems.length);
        console.log('📋 Found menu dropdowns:', menuDropdowns.length);
        
        // Debug: List all menu items found
        menuItems.forEach((item, index) => {
            console.log(`📋 Menu item ${index}:`, item.dataset.menu, item.textContent.trim());
        });
        let activeMenu = null;
        ...
        actionItems.forEach((item, index) => {
            console.log(`🎯 Action item ${index}:`, item.dataset.action, item.textContent.trim());
        });
    ...
    handleMenuAction(action) {
        ...
        // DEBUG: Log theme actions specifically
        if (action.startsWith('theme-')) {
            console.log('Theme action detected:', action);
            console.log('App has setTheme method:', typeof this.app.setTheme === 'function');
        }
